const Lsi = {
  appName: {
    cs: "Aplikace unicornUu",
    en: "Application unicornUu",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci unicornUu",
      en: "About application unicornUu",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní unicornUu.",
      en: "You can buy your own unicornUu.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci unicornUu.",
      en: "You don't have rights to initialize this unicornUu.",
    },
  },
